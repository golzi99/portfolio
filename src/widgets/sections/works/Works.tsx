...
const worksData = [
  {
    title: 'Task Master',
    text: 'Приложение для управления задачами, созданное для повышения вашей продуктивности и организации. С его помощью вы сможете легко планировать свой день, устанавливать приоритеты и отслеживать выполнение задач.',
    src: './toDoList.jpeg',
  ...
  {
    title: 'Picture-Verse',
    text: 'Инновационная социальная сеть, созданная для того, чтобы объединять людей по всему миру. В Picture-Verse вы можете легко находить и общаться с друзьями, делиться своими мыслями, фотографиями, а также участвовать в интересных обсуждениях. Picture-Verse может стать вашим надежным проводником в мире социальных сетей.',
    src: './pictureverse.jpg',
    altText: 'Picture-Verse project',
    techText: 'NextJS',
